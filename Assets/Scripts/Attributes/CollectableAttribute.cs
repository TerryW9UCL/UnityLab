...
public class CollectableAttribute : MonoBehaviour
{
	...
	private void OnTriggerExit2D(Collider2D otherCollider)
	{
		...
		if(playerTag == "Player" || playerTag == "Player2")
		{
			...
			GameObject.FindGameObjectsWithTag ("gate") [0].GetComponent<Collider2D>().enabled = true;
			GameObject.FindGameObjectsWithTag("gate")[0].GetComponent<Renderer>().material.color = Color.grey;
